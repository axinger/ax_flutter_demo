      ...
      body: Center(
        child: Column(
          children: [
            Obx(
              () => Text(
                '名称 ${controller.model().name} ',
                style: TextStyle(fontSize: 20.0),
              ),
            ),
            Obx(
              () => Text(
                '价格 ${controller.model().price} ',
                style: TextStyle(fontSize: 20.0),
              ),
            ),
            Obx(
              () => Text(
                'age: ${controller.model().age} ',
                style: TextStyle(fontSize: 20.0),
              ),
            ),
            Obx(
              () => Text(
                'controller = 价格 ${controller.price} ',
                style: TextStyle(fontSize: 20.0),
              ),
            ),
            ...
            GetBuilder<OrderDetailController>(
              builder: (_) {
                ...
                return Center(
                  child: Text('GetBuilder名称: ${controller.model().name}'),
                );
              },
            ),
            GetBuilder<OrderDetailController>(
              ...
              builder: (_) {
                ...
                return Center(
                  child: Text('GetBuilder价格: ${controller.model().price}'),
                );
              },
            ),
            Divider(color: Colors.red),
