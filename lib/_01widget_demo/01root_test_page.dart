  ...
  List<CellItem> get dataList {
    return [
      ...
      CellItem(
        ...
        onTap: () {
          Get.to(P01ContentPage4());
        },
      ),
      CellItem(
        title: '02-SliverList 和 SliverGrid',
        onTap: () {
          Get.to(P02SlivergridPage());
        },
      ),
      CellItem(
        title: '03-复选,开关等',
        onTap: () {
          Get.to(MaterialPageDate());
        },
      ),
      CellItem(
        title: '04-弹窗',
        onTap: () {
          Get.to(P04MaterialPageDialog());
        },
      ),
      CellItem(
        title: '05-Chip 标签',
        onTap: () {
          Get.to(MaterialPageChip());
        },
      ),
      CellItem(
        title: '06-Table',
        onTap: () {
          Get.to(DemoTablePage());
        },
      ),
      CellItem(
        title: '06-DataTable',
        onTap: () {
          Get.to(MaterialDataTablePage());
        },
      ),
      CellItem(
        title: '07-分页DataTable',
        onTap: () {
          Get.to(MaterialPaginatedDataTablePage());
        },
      ),
      CellItem(
        title: '08-卡片',
        onTap: () {
          Get.to(MaterialPageCard());
        },
      ),
      CellItem(
        title: '09-步骤',
        onTap: () {
          Get.to(MaterialPageStepper());
        },
      ),
      CellItem(
        title: '10-InheritedWidget子widget之间传参',
        onTap: () {
          Get.to(MaterialPageInheritedWidget());
        },
      ),
      CellItem(
        title: '11-Stream 监听',
        onTap: () {
          Get.to(MaterialPageStream());
        },
      ),
      CellItem(
        title: '12-RxDart',
        onTap: () {
          Get.to(MaterialPageRxDart());
        },
      ),
      CellItem(
        title: '13-Bloc业务',
        ...
        onTap: () {
          Get.to(MaterialPageBloc());
        },
      ),
      CellItem(
        title: '14-各种BuilderWidget',
        onTap: () {
          Get.to(P14AllBuilderPage());
        },
      ),
      CellItem(
        title: '15-动画',
        onTap: () {
          Get.to(P15AnimationDemo());
        },
      ),
      CellItem(
        title: '16-国际化',
        onTap: () {
          Get.to(MaterialPageI18n());
        },
      ),
      CellItem(
        title: '17-本地存储',
        onTap: () {
          Get.to(MaterialPageSql());
        },
      ),
      CellItem(
        title: '18-多行Text',
        onTap: () {
          Get.to(MaterialPageMoreText());
        },
      ),
      CellItem(
        title: '19-自定义插件',
        onTap: () {
          Get.to(MaterialPagePlugin());
        },
      ),
      CellItem(
        title: '20-相机和相册',
      ...
      CellItem(
        ...
        onTap: () {
          //   Get.to( ListViewActionPage());
        },
      ),
      CellItem(
        title: '25-ListView,多个拼接,禁止滚动,截图',
        onTap: () {
          Get.to(P25MoreListViewPage());
        },
      ),
      CellItem(
        title: '26-EVENT_BUS,封装stream',
        onTap: () {
          Get.to(P26TestEventPage());
        },
      ),
      CellItem(
      ...
      CellItem(
        ...
        onTap: () {
          Get.to(AnimatedListSample());
        },
      ),
      CellItem(
        title: '30-包含在溢出下拉菜单中',
        onTap: () {
          Get.to(BasicAppBarSample());
        },
      ),
      CellItem(
        title: '31-AnimatedWidget',
        onTap: () {
          Get.to(P31TestAnimation());
        },
      ),
      CellItem(
        title: '32-AnimatedBuilder',
        onTap: () {
          Get.to(P32TestAnimation());
        },
      ),
      CellItem(
        title: '32-Hive数据存储',
      ...
      CellItem(
        ...
        onTap: () {
          Get.to(P34MultiProvider());
        },
      ),
      CellItem(
        title: '35-TestWidget',
        onTap: () {
          Get.to(P35TestTodoList());
        },
      ),
      CellItem(
        title: '36-识别',
        onTap: () {
          Get.to(P36TouchAuthDemoPage());
        },
      ),
      CellItem(
        title: '37-P37PopupRoutePage',
        onTap: () {
          //   Get.to( P37PopupRoutePage());
        },
      ),
      CellItem(
        title: '38-居中向上布局',
        onTap: () {
          Get.to(P38CenterUpPage());
        },
      ),
      CellItem(
        title: '39-圆形图片',
        onTap: () {
          Get.to(P39CirclePage());
        },
      ),
      CellItem(
        title: '40-获得尺寸',
      ...
      CellItem(
        ...
        onTap: () {
          //   Get.to( P41FlutterReduxApp());
        },
      ),
      CellItem(
        title: '41-图片',
        onTap: () {
          //              Get.to( P42ImageBrowser());
        },
      ),
      CellItem(
        title: '42-自定义服务器请求',
        onTap: () {
          Get.to(P42NetTestPage());
        },
      ),
      CellItem(
        title: '43-搜索',
        onTap: () {
          Get.to(P43SearchPage());
        },
      ),
      CellItem(
        title: '44-自定义相机',
        onTap: () {
          Get.to(CameraDemoPage());
        },
      ),
      CellItem(
        title: '45-HeroDemo',
      ...
      CellItem(
        title: '48-图片浏览器',
        onTap: () {
          Get.to(P48PhotoAlbum());
        },
      ),
      CellItem(
        title: '49-侧滑删除',
        onTap: () {
          Get.to(P49DismissibleWidget());
        },
      ),
      CellItem(
      ...
      CellItem(
        ...
        onTap: () {
          Get.to(P51NestedScrollView());
        },
      ),
      CellItem(
        title: '52-跳转指定位置',
        onTap: () {
          Get.to(P52ScrollablePositionedList());
        },
      ),
      CellItem(
        title: '53-拖拽滚动布局',
        onTap: () {
          Get.to(P53DraggableScrollableSheet());
        },
      ),
      CellItem(
        title: '54 吸顶效果1',
        onTap: () {
          Get.to(P54SliverPersisten());
        },
      ),
      CellItem(
        title: 'P55BottomTabBarWidget',
        onTap: () {
          Get.to(P55BottomTabBarWidget());
        },
      ),
      CellItem(
        title: 'P56StatefulBuilder局部刷新',
        onTap: () {
          Get.to(P56StatefulBuilder());
        },
      ),
      CellItem(
        title: 'P57自定义路由动画',
        onTap: () {
          Get.to(P57CustomRoute());
        },
      ),
      CellItem(
        title: 'P58通常展示在应用程序的左边或者右边',
        onTap: () {
          Get.to(P58NavigationRailPage());
        },
      ),
      CellItem(
        title: 'P59Get框架 改变主题',
