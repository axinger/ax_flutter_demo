...
class _MyApp extends State<MainApp> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
  ...
  /// 全局浮层
  void _overlayEntry() {
    /// FloatingActionButton，因为它是 Flutter 专门为圆形按钮设计的组件，使用起来更简单且效果更好
  ...
  void getDeviceInfo() async {
    if (kIsWeb) {
      print("运行是浏览器");
      // print("OS: ${Platform.operatingSystem}"); // 在 Web 返回 "web"
      return;
    }
